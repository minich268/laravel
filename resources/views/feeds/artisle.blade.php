<article class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl px-8 pb-8 pt-40 max-w-sm mx-auto mt-24">
    ...
    <h3 class="z-10 mt-3 text-3xl font-bold text-white">{{$feed->artisle->name}}</h3>
    <div class="z-10 gap-y-1 overflow-hidden text-sm leading-6 text-gray-300">{{$feed->artisle->description_small}}</div>
</article>
