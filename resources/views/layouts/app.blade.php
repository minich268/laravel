...
<nav class="flex justify-center flex-wrap gap-6 text-gray-500 font-medium">
    ...
    <a class="hover:text-gray-900" href="#">Галерея</a>
    <a class="hover:text-gray-900" href="#">Новости</a>
    <a class="hover:text-gray-900" href="#">Контакты</a>
    <a class="hover:text-gray-900" href="#">Вопрос-ответ</a>
    <a class="hover:text-gray-900" href="#">Форма обратной связи</a>
</nav>
